...
const checks = [
  ...
  ["CoachVision explicit correction markers", "src/features/report/components/CoachVisionStudio.tsx", "amber = what to change"],
  ["CoachVision dotted body linkages", "src/features/report/components/CoachVisionStudio.tsx", "thin dots = body links"],
  ["CoachVision clean original control", "src/features/report/components/CoachVisionStudio.tsx", "Original footage only"],
  ["CoachVision six-link view", "src/features/report/components/CoachVisionStudio.tsx", "Six body links"],
