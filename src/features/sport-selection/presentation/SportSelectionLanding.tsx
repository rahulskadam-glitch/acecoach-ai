...
import { ArrowRight, Camera, Check, Play, ShieldCheck, Sparkles, Star, Target } from "lucide-react";
...
export default function SportSelectionLanding({ sports, authenticated }: { sports: SportDefinition[]; authenticated: boolean }) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#1b4332] text-white">
      <header className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            onClick={startTennis}
            disabled={selected}
            className="min-h-11 rounded-full bg-[#d7e022] px-5 text-sm font-bold text-[#1b4332] hover:bg-white disabled:opacity-60 transition"
          >
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-84px)] max-w-7xl items-center gap-12 px-5 pb-16 pt-8 sm:px-8 lg:grid-cols-[1fr_0.9fr] lg:py-20">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <button type="button" onClick={startTennis} disabled={selected} className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl bg-[#d7e022] px-7 font-bold text-[#1b4332] shadow-2xl shadow-lime-300/10 hover:bg-white disabled:cursor-wait disabled:opacity-60">{selected ? "Opening…" : "Analyze a stroke"}<ArrowRight className="h-5 w-5 transition group-hover:translate-x-1" /></button>
        ...
        <div className="relative z-10 mx-auto w-full max-w-md">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/15 bg-[#0C263C] p-3 shadow-2xl">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[2rem] bg-[radial-gradient(circle_at_50%_15%,rgba(59,216,164,.35),transparent_34%),linear-gradient(180deg,#123852_0%,#081a2b_100%)] p-5">
              ...
              <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/10 bg-[#1b4332]/90 p-4 backdrop-blur">
      ...
      <section id="how" className="bg-[#e6ede0] px-5 py-16 text-slate-950 sm:px-8 sm:py-24">
        <div className="mx-auto max-w-6xl">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#40916c]">From court to clarity</p>
      ...
      <section className="bg-[#0b1e30] px-5 py-16 text-white sm:px-8 sm:py-24 border-t border-white/10">
        <div className="mx-auto max-w-6xl space-y-10">
          ...
          <div className="text-center pt-4">
            <Link
              href="/pricing"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#d7e022] px-8 text-sm font-black text-[#1b4332] hover:bg-white transition shadow-lg shadow-lime-300/10"
            >
