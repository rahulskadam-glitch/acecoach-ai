...
const levels = [
  ...
  { label: "Unavailable", icon: AlertTriangle, description: "The video cannot support the measurement. Athlentra withholds it instead of guessing." },
];
...
const boundaries = [
  ...
  "No tactical or shot-selection coaching (rally patterns, serve-plus-one, return depth) until ball tracking is validated—today's analysis covers technique only.",
];

export default function MethodologyPage() {
  return <ContextualPageShell>
    <div className="mx-auto max-w-5xl space-y-6">
      <header className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8"><p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-800">How analysis works</p><h1 className="mt-3 text-3xl font-semibold tracking-[-0.035em] text-slate-950 sm:text-4xl">Know what Athlentra measured—and what it did not</h1><p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">Reports explain what is visible, how confident the result is, how the camera affects it, and what could not be measured.</p></header>
