...
export default function VersionPage() {
  return (
    <main className="min-h-screen bg-[#F6F8FB] px-5 py-12 text-slate-950 sm:px-8 sm:py-16">
      <section className="mx-auto max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-200/60">
        <div className="border-b border-slate-200 p-7 sm:p-9"><AceCoachMark /><div className="mt-8 flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.18em] text-blue-800"><BadgeCheck className="h-5 w-5" />Installed build verification</div><h1 className="mt-4 text-4xl font-semibold tracking-[-0.035em]">AceCoach AI v{APP_VERSION}</h1><p className="mt-2 text-xl text-slate-600">{APP_RELEASE_NAME}</p></div>
