    ...
    categoryReferences: [
      {
        ...
        rightsNote: "Public YouTube embed from the source channel; Athlentra does not download or redistribute the video.",
      },
      {
    ...
    categoryReferences: [
      {
        ...
        rightsNote: "External governing-body library; Athlentra links to the source and does not redistribute its media.",
      },
    ],
    eliteReferences: [],
